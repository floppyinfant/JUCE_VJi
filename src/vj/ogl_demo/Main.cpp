...
public:
    ...
    const juce::String getApplicationName() override       { return "OpenGLAppDemo"; }
    const juce::String getApplicationVersion() override    { return "1.0.0"; }

    void initialise (const juce::String&) override
    {
        mainWindow.reset (new MainWindow ("OpenGLAppDemo", std::make_unique<OpenGLAppDemo>(), *this));
    }
